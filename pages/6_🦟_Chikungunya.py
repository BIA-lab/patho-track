...
def main():
    ...
    ## Getting the data
    df_africa = load_data('data/chikungunya/metadata-all-lineages.csv')
    ...
    st.sidebar.title("CLIMADE AFRICA - CHIKUNGUNYA")
    ...
    if map_option == 'Total of genomes':
        ...
        voc_selected = c1.selectbox("Choose lineages to show", chikv_lineages)
